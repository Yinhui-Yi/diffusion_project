...
def main():
    ...
    pipe = FluxImagePipeline.from_model_manager(
        ...
        controlnet_config_units=[
            ControlNetConfigUnit(
                processor_id="canny",
                model_path="models/alimama-creative/FLUX.1-dev-Controlnet-Inpainting-Beta/diffusion_pytorch_model.safetensors",
                scale=0.3
            ),
            ControlNetConfigUnit(
                processor_id="depth",
    ...
    prompt1 = "The bride surround by her father, mother and huzband"
    prompt2 = "exposes her chest, suck her nipple"
    result = {
        "prompt": prompt1,
        "images": []
    }
    for i in range(4):
        ...
        image1 = pipe(
            prompt=prompt1, seed=random_seed
        )
        result["images"].append((image1, random_seed))
        image2 = pipe(
            prompt=prompt2,
            controlnet_image=image1,
